...
# Parametros definidos para la particula
g = 9.81*_m/_s**2
d = 0.15*_mm
...
# Coeficientes determinados para las fuerzas hidrodinamicas utilizadas
...
# Coordenadas vectoriales, eje x,y
ihat = array([1,0])
jhat = array([0,1])
...
# Funcion de velocidad del flujo
